    ...
    <nav
        ...
        <div class="container-fluid">
            ...
            <ul
                ...
                <li
                    class="nav-item topbar-icon dropdown hidden-caret d-flex d-lg-none intro-x">
                    <a
                ...
                <li
                    class="nav-item topbar-icon dropdown hidden-caret intro-x">
                    <a
                        class="nav-link dropdown-toggle"
                        href="#"
                        id="messageDropdown"
                            ...
                            <div
                                ...
                                <div class="notif-center">
                                    <a href="#">
                                        <div class="notif-img">
                                            <img
                                                src="assets/images/Yellitare.png"
                                                alt="Img Profile" />
                                        </div>
                                        <div
                                            class="notif-content">
