<div>
    <div class=" card-module-info mb-4 ">
        ...
        <div class="idee d  w-100">
            <div class="idee-info">
                <p class="me-2">Expositions</p> <!-- Modifier "expositions de transport" -->
                <span class="user-count bg-white">@{{ paginations['exposition'].totalItems }}</span>
            </div>
            <div class="add-button m-0 p-0 ">
                ...
                <div class="dropdown-menu dropdown-menu-end rounded">
                    ...
                    <a class="dropdown-item" ng-click="showModalAdd('exposition')">
                        <i class="fas fa-user-plus"></i> Ajouter un exposition
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" ng-click="showModalAdd('exposition', {is_file_excel:true, title: 'Ajouter plusieurs expositions'})">
                        <i class="fas fa-user-plus"></i> Ajouter plusieurs expositions
                    </a>
                    <div class="dropdown-divider"></div>
                </div>
            </div>
            ...
            <div class="card-body bg-white">
                <div class="row w-100 m-auto bg-white shadow-none m-0 p-0 g-0 ">
                    ...
                    <div class="col-md-4 col-12 px-2">
                        <select id="searchoption_list_exposition" name="searchoption" select2 style="width: 100%">
                    ...
                    <div class="col-md-4 col-12 mb-3 mb-md-0 px-2">
                        <input type="text" class=" form-control filtre" id="searchtexte_list_exposition" ng-model="searchtexte_list_exposition" placeholder="Chercher par  designation">
                    </div>
            ...
            <div class="card-footer bg-white">
                <div class="row bg-white shadow-none  ">
                    ...
                    <div class="col-md-8 col-12 text-center text-md-end">
                        <button profil="button" class="btn btn-outline-dark mx-2 rounded-pill btn-custom" ng-click="emptyform('exposition', true)">
                            <i class="fa fa-times"></i> Annuler
                        </button>
                        <button profil="button" class="btn btn-dark rounded-pill btn-custom" ng-click="pageChanged('exposition');activefilter()">
    ...
    <div class="card-table">
        <div class="table-responsive">
            <table class="table ">
                ...
                <tbody>
                    <tr class=" intro-x" ng-repeat="item in dataPage['expositions']">
                        <td>@{{ item.titre || '--------' }}</td>
                        <td>@{{ item.type_exposition || '-------' }}</td>
                        <td>@{{ item.date_debut || '-------' }}</td>
                        <td>@{{ item.date_fin || '-------' }}</td>
                        <td>@{{ item.prix_supplement || '0' }} FCFA</td>
                        <td>@{{ item.places_disponibles || '-------' }}</td>
                        <td>
                            <span class="badge rounded-pill  bg-success" ng-class="{
                        ...
                        <td>
                            <div class="gooey-menu">
                                ...
                                <div data-toggle="modal" ng-click="showModalUpdate('exposition',item.id)" class="button press">
                                    <i style="margin-left: 15%;margin-top: 25%;" class="fa fa-edit"></i>
                                </div>
                                <div class="button press" ng-click="deleteElement('exposition',item.id)">
                                    <i style="margin-left: 5%;margin-top: 25%;" class="fa fa-trash"></i>
                                </div>
                                <button class="button press" ng-click="customRedirect('list-detailexposition',item.id)">
        ...
        <div class=" d-flex justify-content-between align-items-center">
            <div class="">
                ...
                <select style="width: 70px" select2 ng-model="paginations['exposition'].entryLimit" ng-change="pageChanged('exposition')" class="select_2">
            ...
            <div class="">
                <nav aria-label="Page navigation">
                    <ul style="width: 100%" class="pagination" uib-pagination total-items="paginations['exposition'].totalItems" ng-model="paginations['exposition'].currentPage" max-size="paginations['exposition'].maxSize" items-per-page="paginations['exposition'].entryLimit" ng-change="pageChanged('exposition')" previous-text="‹" next-text="›" first-text="«" last-text="»" boundary-link-numbers="true" rotate="false">
                    </ul>
                </nav>
            </div>
        </div>
