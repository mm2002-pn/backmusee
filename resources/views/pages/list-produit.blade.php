<div>
    <div class=" card-module-info mb-4 ">
        ...
        <div class="idee d  w-100">
            <div class="idee-info">
                <p class="me-2">Produits</p>
                <span class="user-count bg-white">@{{ paginations['produit'].totalItems }}</span>
            </div>
            <div class="add-button m-0 p-0 ">
                ...
                <div class="dropdown-menu dropdown-menu-end rounded">
                    ...
                    <a class="dropdown-item" ng-click="showModalAdd('produit')">
                        <i class="fas fa-user-plus"></i> Ajouter un produit
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" ng-click="showModalAdd('produit', {is_file_excel:true, title: 'Ajouter plusieurs produits'})">
                        <i class="fas fa-user-plus"></i> Ajouter plusieurs produits
                    </a>
                    <div class="dropdown-divider"></div>
                </div>
            </div>
            ...
            <div class="card-body bg-white">
                <div class="row w-100 m-auto bg-white shadow-none m-0 p-0 g-0 ">
                    ...
                    <div class="col-md-4 col-12 px-2">
                        <select id="searchoption_list_produit" name="searchoption" select2 style="width: 100%">
                    ...
                    <div class="col-md-4 col-12 mb-3 mb-md-0 px-2">
                        <input type="text" class=" form-control filtre" id="searchtexte_list_produit" ng-model="searchtexte_list_produit" placeholder="Chercher par  designation">
                    </div>
                    <!-- Rechercher par profil -->
                    <div class="col-md-4 col-12 mb-3 mb-md-0 px-2">
                        <select id="categorie_list_produit" select2 style="width: 100%">
            ...
            <div class="card-footer bg-white">
                <div class="row bg-white shadow-none  ">
                    ...
                    <div class="col-md-8 col-12 text-center text-md-end">
                        <button profil="button" class="btn btn-outline-dark mx-2 rounded-pill btn-custom" ng-click="emptyform('produit', true)">
                            <i class="fa fa-times"></i> Annuler
                        </button>
                        <button profil="button" class="btn btn-dark rounded-pill btn-custom" ng-click="pageChanged('produit')">
    ...
    <div class=" card-table">
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    <tr class=" intro-x" ng-repeat="item in dataPage['produits']">
                        <th><img src="@{{ item.imgurl ? item.imgurl : item.image }}" class="img-produit" alt="@{{ item.designation }}">
                        </th>
                        ...
                        <td>
                            <div class="gooey-menu">
                                ...
                                <div data-toggle="modal" ng-click="showModalUpdate('produit',item.id)" class="button press">
                                    <i style="margin-left: 15%;margin-top: 25%;" class="fa fa-edit"></i>
                                </div>

                                <div class="button press" ng-click="deleteElement('produit',item.id)">
        ...
        <div class=" d-flex justify-content-between align-items-center">
            <div class="">
                ...
                <select style="width: 70px" select2 ng-model="paginations['produit'].entryLimit" ng-change="pageChanged('produit')" class="select_2">
