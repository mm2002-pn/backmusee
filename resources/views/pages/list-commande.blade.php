<div>
    <div class=" card-module-info mb-4 ">
        ...
        <div class="idee d  w-100">
            <div class="idee-info">
                <p class="me-2">commandes</p>
                <span class="user-count bg-white">@{{ paginations['commande'].totalItems }}</span>
            </div>
            <div class="add-button m-0 p-0 ">
                ...
                <div class="dropdown-menu dropdown-menu-end rounded">
                    ...
                    <a class="dropdown-item" ng-click="showModalAdd('commande')">
                        <i class="fas fa-user-plus"></i> Ajouter un commande
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" ng-click="showModalAdd('commande', {is_file_excel:true, title: 'Ajouter plusieurs commandes'})">
                        <i class="fas fa-user-plus"></i> Ajouter plusieurs commandes
                    </a>
                    <div class="dropdown-divider"></div>
                </div>
            </div>
            ...
            <div class="card-body bg-white">
                <div class="row w-100 m-auto bg-white shadow-none m-0 p-0 g-0 ">
                    ...
                    <div class="col-md-4 col-12 px-2">
                        <select id="searchoption_list_commande" name="searchoption" select2 style="width: 100%">
                    ...
                    <div class="col-md-4 col-12 mb-3 mb-md-0 px-2">
                        <input type="text" class=" form-control filtre" id="searchtexte_list_commande" ng-model="searchtexte_list_commande" placeholder="Chercher par  designation">
                    </div>
                    <!-- Rechercher par profil -->
                    <div class="col-md-4 col-12 mb-3 mb-md-0 px-2">
                        <select id="categorie_list_commande" select2 style="width: 100%">
            ...
            <div class="card-footer bg-white">
                <div class="row bg-white shadow-none  ">
                    ...
                    <div class="col-md-8 col-12 text-center text-md-end">
                        <button profil="button" class="btn btn-outline-dark mx-2 rounded-pill btn-custom" ng-click="emptyform('commande', true)">
                            <i class="fa fa-times"></i> Annuler
                        </button>
                        <button profil="button" class="btn btn-dark rounded-pill btn-custom" ng-click="pageChanged('commande')">
    ...
    <div class=" card-table">
            ...
            <table class="table">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th>Adresse Livraison/Point de retrait</th>
                        <th>Date commande</th>
                        <th>Statut</th>
                        <th>Nbre articles</th>
                ...
                <tbody>
                    <tr class=" intro-x" ng-repeat="item in dataPage['commandes']">
                        ...
                        <td>
                            <div class="gooey-menu">
                                ...
                                <div data-toggle="modal" ng-click="showModalUpdate('commande',item.id)" class="button press">
                                    <i style="margin-left: 15%;margin-top: 25%;" class="fa fa-edit"></i>
                                </div>

                                <div class="button press" ng-click="deleteElement('commande',item.id)">
        ...
        <div class=" d-flex justify-content-between align-items-center">
            <div class="">
                ...
                <select style="width: 70px" select2 ng-model="paginations['commande'].entryLimit" ng-change="pageChanged('commande')" class="select_2">
            ...
            <div class="">
                <nav aria-label="Page navigation">
                    <ul style="width: 100%" class="pagination" uib-pagination total-items="paginations['commande'].totalItems" ng-model="paginations['commande'].currentPage" max-size="paginations['commande'].maxSize" items-per-page="paginations['commande'].entryLimit" ng-change="pageChanged('commande')" previous-text="‹" next-text="›" first-text="«" last-text="»" boundary-link-numbers="true" rotate="false">
                    </ul>
                </nav>
            </div>
        </div>
